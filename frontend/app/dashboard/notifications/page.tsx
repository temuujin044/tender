...
const typeConfig = {
  ...
  new: {
    label: 'Тендерийн мэдээлэл',
    icon: FileText,
    iconColor: 'text-orange-600',
    bgColor: 'bg-orange-50',
  },
  result: {
    label: 'Тендерийн үр дүн',
    icon: CheckCircle,
    iconColor: 'text-emerald-600',
    bgColor: 'bg-emerald-100',
  },
} satisfies Record<
  VendorNotification['type'],
  { label: string; icon: typeof Bell; iconColor: string; bgColor: string }
>;
      ...
      .catch((requestError) =>
        setError(
          requestError instanceof Error
            ...
            : 'Мэдэгдлийн мэдээлэл ачаалж чадсангүй.'
        )
      )
      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8">
          ...
          <p className="mt-1 text-muted-foreground">
            Backend мэдээллийн сан дахь тендерийн төлөв, хугацаа болон оролцооны мэдээлэл.
          </p>
        </header>
          ...
          <CardContent className="p-0">
            {loading ? (
              <div className="flex min-h-64 items-center justify-center gap-3 text-sm text-muted-foreground">
                ...
                Мэдээллийг backend-ээс ачаалж байна...
              </div>
            ) : error ? (
              ...
              <div className="py-16 text-center">
                ...
                <p className="mt-4 text-muted-foreground">
                  Мэдэгдэл үүсгэх тендерийн үйл явдал алга.
                </p>
              </div>
            ) : (
              <>
