...
export default function RegisterPage() {
  ...
  const getSelectClass = (field: keyof CompanyFormData) =>
    cn(
      'h-11 bg-slate-50',
      errors[field] ? 'border-red-500 focus:ring-red-500' : 'border-slate-200 focus:ring-orange-500'
    );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        username: requestError instanceof Error ? requestError.message : 'Бүртгэл хадгалагдсангүй.',
      });
      setIsLoading(false);
    }
  };
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-slate-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mb-10 text-lg text-slate-300">
            Компаниа бүртгүүлж, профайл мэдээллээ бүрэн оруулснаар тендерийн урилгуудыг шууд хүлээн
            авах боломжтой.
          </p>
          ...
          <div className="space-y-6">
            {steps.map((item) => (
              <div key={item.id} className="flex items-start gap-4">
                ...
                <div className="pt-2">
                  <p
                    className={cn('font-medium', step >= item.id ? 'text-white' : 'text-slate-500')}
                  >
                    {item.name}
                  </p>
                </div>
            ...
            <CardHeader className="space-y-2 px-6 pb-6 pt-8">
              ...
              <CardDescription className="space-y-1 text-slate-500">
                <span className="block">
                  ...
                  {step === 2 && 'Холбоо барих үндсэн ажилтны мэдээллийг оруулна уу.'}
            ...
            <CardContent className="px-6 pb-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                      ...
                      <div className="relative">
                        <Building2
                          className={cn(
                            ...
                            errors.companyName ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                          id="companyName"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <FileText
                          className={cn(
                            'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                            errors.registrationNumber ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex h-11 items-center justify-between rounded-md border border-slate-200 bg-slate-50 px-3">
                        <div className="space-y-0.5">
                          <p className="text-sm font-medium text-slate-700">НӨАТ төлөгч</p>
                  ...
                  <div className="grid gap-5 md:grid-cols-2">
                    <div className="space-y-2">
                      <Label htmlFor="businessDirection" className="text-slate-700">
                    ...
                    <div className="relative">
                      <MapPin
                        className={cn(
                          ...
                          errors.companyAddress ? 'text-red-500' : 'text-slate-400'
                        )}
                      />
                      <Textarea
                        id="companyAddress"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Phone
                          className={cn(
                            'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                            errors.companyPhone ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                          id="companyPhone"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Mail
                          className={cn(
                            'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                            errors.companyEmail ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                          id="companyEmail"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <User
                        className={cn(
                          'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                          errors.contactName ? 'text-red-500' : 'text-slate-400'
                        )}
                      />
                      <Input
                        id="contactName"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Phone
                          className={cn(
                            'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                            errors.contactPhone ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                          id="contactPhone"
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Mail
                          className={cn(
                            'absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2',
                            errors.contactEmail ? 'text-red-500' : 'text-slate-400'
                          )}
                        />
                        <Input
                          id="contactEmail"
